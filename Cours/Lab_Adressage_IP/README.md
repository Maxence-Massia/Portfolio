...
### ✅ Objectifs atteints
- Définir des sous-réseaux avec masques CIDR (/25 à /30)
- Configurer les interfaces IP de routeurs et hôtes
- Vérifier la communication entre les réseaux
...
### ✅ Objectifs atteints
- Création de sous-réseaux à partir d’un réseau principal
- Configuration d’un schéma IP cohérent
- Vérification de la connectivité locale et inter-réseaux
...
- Ajout manuel de routes statiques correctes
- Vérification du ping et de la navigation vers un serveur distant
...
### ✅ Objectifs atteints
- Repérage des erreurs d'adressage IP
- Définition correcte des passerelles par défaut
- Résolution des problèmes de connectivité locale et distante

---

## 🧠 Compétences mobilisées

- Calcul et configuration de sous-réseaux (CIDR)
- Maîtrise des commandes de **dépannage réseau**
...
### ✅ Objectifs atteints
- Diagnostic des tables de routage incorrectes
